  ...
  return (
    <main>
      ...
      <div className="mx-auto max-w-[1440px] px-6 pt-8 lg:px-8">
        <Link href="/peru-in#support-stats" className="text-sm text-mission-navy underline-offset-4 hover:underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4">← Back to Peru IT services</Link>
      </div>
      <SupportStatsDetail />
      <SiteFooter />
    </main>
