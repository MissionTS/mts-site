...
const team: TeamProfile[] = [
  { name: "Ashley Padgett", role: "Billing & Executive Assistant", bio: "Ashley helps keep the client experience organized and responsive behind the scenes. From billing coordination to day-to-day support for the Mission team, she helps make sure the details do not get in the way of great service.", image: "/photos/team-ashley.png" },
  { name: "Jonathan Davis", role: "Installation Technician", bio: "Jonathan supports the hands-on work that brings technology projects to life. He approaches installations with care and attention to the details that make systems easier to maintain and use.", image: "/photos/team-jonathan.jpg" },
